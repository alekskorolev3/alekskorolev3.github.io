                        ...
                        <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div className="space-y-1">
                                        <p className="text-gray-600">
                                            Беларусь: <a href={`tel:${PHONE}`} className="text-gray-600 hover:text-black transition-colors">{PHONE_TEXT}</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <div className="space-y-1">
                                        <p className="text-gray-600">
                                            Telegram: <a href={TELEGRAM} target="_blank" className="text-gray-600 hover:text-black transition-colors">{PHONE}</a>
                                        </p>
                                        <p className="text-gray-600">
                                            WhatsApp: <a href={WHATSAPP} className="text-gray-600 hover:text-black transition-colors">{PHONE}</a>
                                        </p>
                                    </div>
                                </div>
                            </div>

...
export default function About() {
    return (
        <div className="bg-white text-gray-900">
            ...
            <section className="max-w-6xl mx-auto px-4 py-12 md:py-20">
                <div className="max-w-3xl">
                    ...
                    <p className="text-base md:text-lg text-gray-600">
                        Мы — небольшой специализированный сервис подбора автомобилей в Минске.
                        Помогаем найти действительно живую машину — без скрытых проблем, юридических рисков и переплат.
                    </p>
                </div>
            </section>
            ...
            {/* Process */}
            <section className="max-w-6xl mx-auto px-4 py-12 md:py-20">
                <h2 className="text-2xl md:text-3xl font-bold mb-6 md:mb-12">
                    Как проходит подбор
                </h2>
                ...
                <div className="max-w-6xl mx-auto px-4 py-12 md:py-20">
                    ...
                    <ul className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 text-gray-700">
                        {[
                            ...
                            <li
                                key={i}
                                className="bg-white border border-gray-200 rounded-lg px-4 py-3 text-sm md:text-base"
                            >
                                ✅ {item}
                            </li>
                        ))}
            ...
            <section className="max-w-6xl mx-auto px-4 py-12 md:py-20">
                ...
                <div className="max-w-3xl space-y-3 md:space-y-4 text-gray-700 text-base md:text-lg">
                    <p>
                        Сейчас сервис находится на этапе запуска, поэтому на сайте ещё нет отзывов клиентов —
                        и мы принципиально не публикуем выдуманные.
                    </p>
                    <p>
                        Зато у нас есть реальный практический опыт подбора и покупки автомобилей, понимание рынка,
                        десятки просмотренных и отсеянных проблемных вариантов и честный подход к работе.
                    </p>
                    <p>
                        Первые клиенты получают максимальное внимание к деталям и особые условия.
                        По завершённым проектам мы начнём публиковать реальные кейсы и отзывы.
                    </p>
                </div>
            </section>
